...
prefs = {
    ...
    'red bg': 2100,
    'saturation': 1.0,
    'save saturation and contrast': False,
    'save window pos': True,
    'scroll wheel horiz': False,
    'sharpness': 1.0,
    'show menubar': True,
